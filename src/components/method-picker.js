    ...
    <div className="methods-picker-wrapper">
      <div className="methods-picker-inner">
        <label className="methods-picker-label">
          ...
          <input hidden={true} type='checkbox' checked={props.methods.getIn([MULTIPLY, 'included'])} onChange={(e) => props.setMethod(MULTIPLY, !props.methods.getIn([MULTIPLY, 'included'])) }/>
        </label>
        <label className="methods-picker-label">
          ...
          <input hidden={true} type='checkbox' checked={props.methods.getIn([PLUS, 'included'])} onChange={(e) => props.setMethod(PLUS, !props.methods.getIn([PLUS, 'included'])) }/>
        </label>
      </div>
    </div>
  );
